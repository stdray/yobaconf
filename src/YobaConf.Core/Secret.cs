...
// KeyVersion for master-key rotation (see decision-log 2026-04-21 "Master-key AES rotation:
// lazy re-encrypt on access"). byte[] equality here is reference-based which is fine — we
// compare secrets by (Key, ScopePath) identity, not by content.
